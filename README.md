...
این اسکریپت با استفاده از کتابخانه داخلی `subprocess` دستورات CLI سیستم‌عامل ویندو (`netsh wlan show profiles`) را اجرا کرده و لیست تمام پروفایل‌های ذخیره‌شده و رمز عبور آن‌ها را استخراج و نمایش می‌دهد.
